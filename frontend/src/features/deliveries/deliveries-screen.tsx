...
const s = StyleSheet.create({
  ...
  card: { gap: 18, paddingVertical: 26, borderBottomWidth: 1, borderBottomColor: colors.line },
  ...
  selectedFile: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, borderRadius: 16, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
