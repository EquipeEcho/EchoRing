...
export type Task = { id: number; title: string; project: string; due: string; done: boolean };
...
export const statusTone = { 'Em tradução': 'blue', 'Em revisão': 'green', 'Aguardando aprovação': 'amber', 'Concluído': 'neutral', 'Nova requisição': 'green' } as const;
type Workspace = {
  projects: Project[]; tasks: Task[]; toggleTask: (id: number) => void; search: string; setSearch: (value: string) => void;
